...
class OperationParameter extends Component {
    ...
    render() {
        ...
        case 'Object':
            input = <ObjectParameter paramValues={paramValues} onChange={this.props.onChange}
                param={param} getValue={getValue}
            />;
            break;
        case 'authority':
            input = <AuthorityParameter paramValues={paramValues} onChange={this.props.onChange}
                param={param} getValue={getValue}
            />;
            break;
        case 'public_key':
